# JSelectDepart 机构选择组件
选择机构组件,存储机构ID,显示机构名称
...
<template>
  <a-form :form="form">
    <a-form-item label="机构选择v-decorator" style="width: 300px">
      <j-select-depart v-decorator="['bumen']"/>
      {{ getFormFieldValue('bumen') }}
    </a-form-item>

    <a-form-item label="机构选择v-model" style="width: 300px">
      <j-select-depart v-model="bumen"/>
      {{ bumen }}
    </a-form-item>

    <a-form-item label="机构多选v-model" style="width: 300px">
