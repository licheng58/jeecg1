<template>
  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="工单id">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="节点任务资料">
          <a-input placeholder="请输入节点任务资料" v-decorator="['urls', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="指派人上传节点任务资料">
          <a-input placeholder="请输入指派人上传节点任务资料" v-decorator="['urlsForUser', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="指派人用户id">
          <a-input placeholder="请输入指派人用户id" v-decorator="['userId', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="指派人姓名">
          <a-input placeholder="请输入指派人姓名" v-decorator="['username', {}]" />
        </a-form-item>
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="所用时间">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="部门姓名">
