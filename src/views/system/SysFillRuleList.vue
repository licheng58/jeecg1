<template>
  <a-card :bordered="false">
          ...
          <a-col :md="6"
            ...
            <a-form-item label="规则名称">
              <a-input placeholder="请输入规则名称"
                       v-model="queryParam.ruleName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6"
                 :sm="8">
            <a-form-item label="规则Code">
              <a-input placeholder="请输入规则Code"
                       v-model="queryParam.ruleCode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6"
                 :sm="8">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary"
                icon="download"
                @click="handleExportXls('填值规则')">导出</a-button>
      <a-upload name="file"
    ...
    <!-- 表单区域 -->
    <sys-fill-rule-modal ref="modalForm"
                         @ok="modalFormOk" />
  </a-card>
</template>
