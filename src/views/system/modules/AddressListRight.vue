<template>
  <a-card class="j-address-list-right-card-box"
          :loading="cardLoading"
          :bordered="false">
...
export default {
  ...
  methods: {
    loadData(pageNum, orgCode) {
      ...
      // update-begin- --- author:wangshuai ------ date:20200102 ---- for:传过来的机构编码为空全查
      if (!orgCode) {
        ...
        // update-end- --- author:wangshuai ------ date:20200102 ---- for:传过来的机构编码为空全查
      } else {
