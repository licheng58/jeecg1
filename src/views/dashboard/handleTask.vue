  ...
  <a-card :bordered="false" style="margin: 16px" :body-style="{ margin: '0', padding: '0 16px 16px' }">
    <a-tabs v-model="tabsAtive" class="com-tabs">
      <a-tab-pane key="5" forceRender>
        ...
        <XTaskList ref="XTaskList" :type="5" @ok="modalOk"></XTaskList>
      </a-tab-pane>
      <a-tab-pane key="1" forceRender>
        ...
        <XWarningRecord ref="XWarningRecord" :type="1" @ok="modalOk"></XWarningRecord>
      </a-tab-pane>
      <a-tab-pane key="6" forceRender>
        ...
        <xTaskAfterLoan ref="xTaskAfterLoan" :type="6" @ok="modalOk"></xTaskAfterLoan>
      </a-tab-pane>
      <a-tab-pane key="7" forceRender>
        ...
        <XTaskAssetList ref="XTaskAssetList" :type="7" @ok="modalOk"></XTaskAssetList>
      </a-tab-pane>
      <a-tab-pane key="8" forceRender>
        ...
        <XTaskAssetProtectionList ref="XTaskAssetProtectionList" :type="8" @ok="modalOk"></XTaskAssetProtectionList>
      </a-tab-pane>
      <a-tab-pane key="2" forceRender>
        ...
        <XBlacklistList ref="XBlacklistList" :type="2" @ok="modalOk"></XBlacklistList>
      </a-tab-pane>
    </a-tabs>
  </a-card>
</template>
